  ...
  render() {
    return (
      <div className={this.state.class}>
        <ReactPlayer style={{position:'relative', bottom: '200'}} width='1535' height='1200' playing loop url="https://www.youtube.com/embed/ToJDRt2xwXU?autoplay=1&rel=0&amp;controls=0&amp;showinfo=0"/>
